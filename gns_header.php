								...
								<div class="main-menu-wrapper">
									...
									<div id="main-menu" class="main-nav zn_mega_wrapper">
										<ul id="menu-main-menu" class="main-menu zn_mega_menu">
											...
											<li class="menu-item-has-children"><a href="gns_about-us.php">VỀ CHÚNG TÔI</a>												
											</li>
											<li class="menu-item-has-children"><a href="gns_services.php">DỊCH VỤ</a>												
											</li>
											<li class="menu-item-has-children"><a href="gns_industries.php">LĨNH VỰC HOẠT ĐỘNG</a>
											</li>
